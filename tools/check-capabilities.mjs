...
const APP = {
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    152: (c) => c.hasCode(/YS_PASS_ITER\s*=\s*100000\b/)
    ...
    151: (c) => !!c.fnBody('ysUsersCacheSave')
    ...
    122: (c) => !/ysCfgSet\('(?:ys_students|ys_attend_sessions|ys_sleep_sessions)'/.test(c.src)
    ...
    150: (c) => !!c.fnBody('changeMyPassword')
