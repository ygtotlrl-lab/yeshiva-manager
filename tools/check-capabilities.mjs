...
const APP = {
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    155: (c) => c.hasCode(/YS_PASS_ITER\s*=\s*100000\b/)
    ...
    154: (c) => !!c.fnBody('ysUsersCacheSave')
    ...
    123: (c) => !/ysCfgSet\('(?:ys_students|ys_attend_sessions|ys_sleep_sessions)'/.test(c.src)
    ...
    151: (c) => !!c.fnBody('changeMyPassword')
