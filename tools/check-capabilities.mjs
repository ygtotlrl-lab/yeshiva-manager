...
const APP = {
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    156: (c) => c.hasCode(/YS_PASS_ITER\s*=\s*100000\b/)
    ...
    155: (c) => !!c.fnBody('ysUsersCacheSave')
    ...
    124: (c) => !/ysCfgSet\('(?:ys_students|ys_attend_sessions|ys_sleep_sessions)'/.test(c.src)
    ...
    152: (c) => !!c.fnBody('changeMyPassword')
